/*
 On 22. february 2017 I was forced to remove this file due to violation of US copyright law. This file
 allowed to generate licenses for synology surveillance station. Considering that you have access to
 synology machine and you are experienced enough to compile simple code in linux console. This code misused
 synology licensing library which purpose was to validate entered code. Coders at synology made interesting
 mistake by keeping also function for generating new activation code inside the same library.
 Every activation code can be used only once. Normally you can buy them in computer stores. And you can
 easily imagine what will happen if you have generated and used some licenses and then some poor guy buys
 this license officially and it won't work... Since some one else is already using the same code illegally.
 
 Gabriel
 
 Discussion between synology and github follows...
 */
