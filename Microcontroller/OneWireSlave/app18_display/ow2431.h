...
#define OW_2431_SCRATCHPAD_LEN 16
extern volatile byte OW_2431_scratchpad_addr;
extern volatile byte OW_2431_scratchpad_len;
extern volatile byte OW_2431_scratchpad_status; // hi nibble - not processed, low nibble - 1=ok, other=error
