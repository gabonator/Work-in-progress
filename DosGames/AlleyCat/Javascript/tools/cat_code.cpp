...
void sub_8E5()
{
  ...
  case 0xA37:
    ...
    set_bx(_data16get(8));
    bl <<= 1;
    if ( get_ax() <= _data16get(bx + 0x66C) ) // jbe 
      { wPos = 0xA4E; continue; }
    set_ax(_data16get(bx + 0x66C));
  case 0xA4E:
  ...
  case 0xB53:
    ...
    if ( _data[0x571] == 1 ) // !jnz
      bl += 4;
  case 0xB64:
    set_ax(_data16get(bx + 0x9A6));
    _data16set(0x55D, get_ax());
    set_ax(_data16get(bx + 0x9C0));
  ...
  case 0xD4F:
    ...
    set_bx(get_bx() & 0x0E);
    set_ax(_data16get(bx + 0x0FC2));
    set_bx(_data16get(bx + 0x0FD2));
    wPos = 0xDA8;
      continue;
  case 0xDA1:
  ...
  case 0xEF1:
    ...
    if ( _data[0x571] != 0x0FF ) // !jz
      bl += 6;
    bh = 0;
    set_ax(_data16get(bx + 0x0FAA));
    _data16set(0x569, get_ax());
    set_ax(_data16get(bx + 0x0FB6));
...
void sub_1419()
{
  ...
  switch (wPos)
  {
    ...
    word_code_13DF = get_ax();
    word_code_13E1 = get_bx();
    word_code_13E3 = get_cx();
    word_code_13E5 = get_dx();
    set_bx(0x14B3);
    if ( _data[0x697] == 0x0FD ) // !jnz
      set_bx(0x14FB);
    _cli();
...
void sub_2690()
{
  ...
  case 0x2698:
    ...
    if ( --cx && (al == _data16get(bx + 0x1F89)) )
      { wPos = 0x2698; continue; }
    if ( al > _data16get(bx + 0x1F89) ) // ja 
