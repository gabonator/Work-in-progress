...
//#define CALIBRATION__MAGN_USE_EXTENDED true
//const float magn_ellipsoid_center[3] = {56.0964, -31.2645, -10.0574};
//const float magn_ellipsoid_transform[3][3] = {{0.952329, 0.0450230, 0.0240223}, {0.0450230, 0.907991, 0.0158328}, {0.0240223, 0.0158328, 0.957911}};
...
void loop()
{
  ...
  if (Serial.available() >= 1)
  {
    ...
    if (cmd == '#') // Start of new control message
    {
      int command = readChar(); //Serial.read(); // Commands
